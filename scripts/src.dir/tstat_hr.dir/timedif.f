...
c     Ensures dates in 4 format YYYYMMDD
      ...
      if (dmode(1:1).eq.'D') then
        ...
        if ((imonth1.lt.1).or.(iday1.lt.1)) go to 130
   ...
   50 continue
      ...
      if ((dmode(1:1).eq.'D').or.(dmode(1:1).eq.'d')) then
        ...
        if ((imonth1.ge.3).and.(mody1.eq.0)) iday1 = iday1 + 1
        iday2 = iday2 + idaym(imonth2) - idaysub
        if ((imonth2.ge.3).and.(mody2.eq.0)) iday2 = iday2 + 1
 ...
 130  continue
      ...
      write (6,*) da1,hr1,iyear1,imonth1,iday1,ihour1,imin1
      write (6,*) da2,hr2,iyear2,imonth2,iday2,ihour2,imin2
      return
 140  continue
      err = 3
