...
c     write (6,*) ' iwrapE=',iwrapE,' iwrapN=',iwrapN,
c    * ' iwrapS=',iwrapS,' nhx=',nhx
...
c-----------------------------------------------------------------------
      ...
      if (idiag.eq.3) then
        outfile=infile(1:lnblnk(infile))//'_recast'
        open (iurcst,file=outfile,form='unformatted',
     *   status='unknown')
c       open (iurcst,file=infile(1:lnblnk(infile))//
c    *   '_recast',form='unformatted',status='unknown')
        write (iurcst) nk2
...
c=======================================================================
     ...
     * mgL,mgR,mgD,mgU,idiag)
      ...
      integer h,hhL,hhR,hhL1,hhR1,nh2
ckk      integer hh,hhh(382),hhmnhx,hhpnhx
      integer hh,hhh(1461),hhmnhx,hhpnhx  !ckk
